...
const ScoreDisplay = ({
  ...
  const getBackgroundClass = (percentage: number) => {
    if (percentage < 30) return 'bg-success-bg border-success/30';
    if (percentage < 60) return 'bg-primary/10 border-primary/30';
    if (percentage < 80) return 'bg-destructive/10 border-destructive/30';
    return 'bg-crisis-bg border-crisis/40';
  };
