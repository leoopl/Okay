...
const BreathingAnimation: React.FC<BreathingAnimationProps> = ({ onClose, breathingTime }) => {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: '#1d1915' }} // background color
    >
      <div className="relative flex flex-col items-center">
        ...
        <div
          className="size-64 content-center justify-items-center rounded-full"
          style={{ backgroundColor: 'oklch(90% 0.03 72 / 0.12)' }}
        >
          <div
            className="size-64 rounded-full bg-white/20"
            style={{
              // backgroundColor: 'oklch(90% 0.03 72)', // bg color set above
